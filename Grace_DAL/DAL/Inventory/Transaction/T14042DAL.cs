...
namespace Grace_DAL.DAL.Inventory.Transaction
{
    ...
    {
        public DataTable GetSalesVerifyData()
        {
            DataTable dtSale = new DataTable();
            dtSale = Query($"SELECT ROW_NUMBER() OVER(Order by T_SALE_ID)SL, T_SALE_ID, T14040.T_MEMO_NO, T14040.T_TYPE_CODE, T14010.T_CUSTOMER_NAME,T14040.T_CUSTOMER_ID, T_GRAND_TOTAL ,T_DISCOUNT, T_AFTER_DISCOUNT,T_PAMENT, T_DUE, T_SALE_TOTAL,  T14040.T_ENTRY_DATE, T14040.T_ENTRY_USER, T11020.T_USER_NAME T_EMP_NAME FROM T14040 JOIN T14010 ON T14040.T_CUSTOMER_ID = T14010.T_CUSTOMER_ID  JOIN T11020 ON T14040.T_ENTRY_USER = T11020.T_USER_CODE WHERE T_VERIFY_FLG IS NULL AND (T_PRE_ORDER IS NULL OR T_PRE_ORDER ='0')  ORDER BY T_SALE_ID ASC");
            return dtSale;
        }
