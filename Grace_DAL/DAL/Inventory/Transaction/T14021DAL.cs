...
{
    public class T14021DAL:CommonDAL
    {
        public DataTable GetPurchaseSummery(T14020Parm paramList, string shopId)
        {
            DataTable sql = new DataTable();
            sql = Query($"SELECT ROW_NUMBER() OVER(Order by T_PURCHASE_ID)SL,T_PURCHASE_ID, T14020.T_INVOICE_NO, T14020.T_TYPE_CODE, T14010.T_CUSTOMER_NAME, T_TOTAL_PRICE, T_DISCOUNT, T_AFTER_DISCOUNT, T_TOTAL_QUT, T_CASH, T_DUE, T14001.T_TYPE_NAME, T14020.T_ENTRY_DATE, T14020.T_ENTRY_USER , T11020.T_USER_NAME T_EMP_NAME, CASE when T_VERIFY_FLG ='1' then 'Verified' else '' end T_VERIFY_FLG,'0' T_PNT_VCHR_FLG FROM T14020 JOIN T14010 ON T14020.T_CUSTOMER_ID = T14010.T_CUSTOMER_ID JOIN T14001 ON T14020.T_TYPE_CODE = T14001.T_TYPE_CODE JOIN T11020 ON T14020.T_ENTRY_USER = T11020.T_USER_CODE  WHERE T_SHOP_ID='{shopId}' AND CONVERT(date, T14020.T_ENTRY_DATE ,104) BETWEEN CONVERT(date, '{paramList.T_FROM_DATE}' ,104) AND CONVERT(date, '{paramList.T_TO_DATE}' ,104)");
            return sql;
        }
        ...
        {
            DataTable sql = new DataTable();
            sql = Query($"SELECT T14003.T_PRODUCT_NAME, T14004.T_PACK_NAME, T14021.T_PURCHASE_PRICE, T14021.T_QUANTITY, T14021.T_TOTAL_PUR_PRICE FROM T14021 JOIN T14003 ON T14021.T_PRODUCT_CODE = T14003.T_PRODUCT_CODE JOIN T14004 ON T14021.T_PACK_CODE = T14004.T_PACK_CODE where T14021.T_PURCHASE_ID='{id}'");
            return sql;
        }
    }
}
