...
{
    public class T14021Controller : Controller
    {
        T14021DAL repository = new T14021DAL();
        // GET: T14021
        [HttpPost]
        public ActionResult GetPurchaseSummery(T14020Parm paramList)
        {
            try
            {
                var shopId = "1";
                var data = repository.GetPurchaseSummery(paramList, shopId);
        ...
        public ActionResult GetPurchaseSummeryReport(string fromDate, string toDate, string shopId)
        {
            var details = repository.GetPurchaseSummeryReport(fromDate, toDate, "1");
            // var dueTotal = repository.GetDueTotal(fdate, tdate);
            ReportViewer rv = new ReportViewer();
            rv.LocalReport.ReportPath = "Reports/RDLC/T14021_Purchase_Summery.rdlc";
            ...
            rddetails.Name = "T14021_Purchase_Summary";//This refers to the dataset name in the RDLC file
        ...
        {
            var head = repository.GettHeaderData(id, "1");
