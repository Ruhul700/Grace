...
{
    public class T14048Controller : Controller
    {
        // GET: T14048
        T14048DAL repository = new T14048DAL();
        ...
        [HttpPost]
        public ActionResult SaveData(T14048Data model, List<T14049Data> list)
        {
            try
            {
                var shopId = Session["site"].ToString();
        ...
        public ActionResult Quotation(int id, string shopId)
        {
            ...
            rv.LocalReport.ReportPath = "Reports/RDLC/T14048_Quotation.rdlc";
            ...
            rds.Name = "T14048_Quotation";//This refers to the dataset name in the RDLC file
            rds.Value = data;
            rddetails.Name = "T14048_Quotation_List";//This refers to the dataset name in the RDLC file
